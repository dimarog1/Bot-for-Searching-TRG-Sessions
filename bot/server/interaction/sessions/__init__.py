...
def init_session_handlers(app: Application):
    ...
    session_conversation_handler = ConversationHandler(
        ...
        states={
            ...
            StatesEnum.START_DATE: [CallbackQueryHandler(sessionController.input_start_date)],
            StatesEnum.START_TIME: [CallbackQueryHandler(sessionController.input_start_time)],
