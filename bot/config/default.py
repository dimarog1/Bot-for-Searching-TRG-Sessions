...
class DefaultSettings(BaseSettings):
    ...
    POSTGRES_DB: str = environ.get("POSTGRES_DB", "bot_db")
    POSTGRES_HOST: str = environ.get("POSTGRES_HOST", "localhost")
    POSTGRES_USER: str = environ.get("POSTGRES_USER", "user")
    POSTGRES_PORT: int = int(environ.get("POSTGRES_PORT", "6432")[-4:])
    ...
    BOT_TOKEN: str = environ.get("BOT_TOKEN", "__place_bot_token_here__")
